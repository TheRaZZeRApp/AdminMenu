...
public class CreateMenus {
    ...
    public static void initMenus (LocaleHelper translator){
        ...
        if (AdminMenu.settings.isServermenu()) {
            ...
            server_00.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_t", "adminmenu.server.timeout", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_t_hover"), f.getRunCommand(), "/chatclick chatmenu adm_m_h_s_t", translator));
            server_00.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_world", "adminmenu.server.world", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_w_hover"), f.getRunCommand(), "/chatclick chatmenu adm_m_h_s_w", translator));
            server_00.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_plugin", "adminmenu.server.plugin", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_plugin_hover"), f.getRunCommand(), "/chatclick chatmenu adm_m_h_s_p", translator));
            ...
            server_01.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_d", "adminmenu.server.debug", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_d_hover"), f.getRunCommand(), "/chatclick chatmenu adm_m_h_s_d", translator));
            ...
            server_timeout.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_afktimeout", "adminmenu.server.timeout.set", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_afktimeout_hover"), f.getSuggestCommand(), "/setidletimeout <minutes>", translator));
            server_timeout.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_c_turnoff", "adminmenu.server.timeout.turnoff", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_afktimeout_disable_hover"), f.getRunCommand(), "/setidletimeout 0", translator));
            ...
            server_world.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_w_create", "adminmenu.server.world.create", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_w_create_hover"), f.getSuggestCommand(), "/world create <worldName>", translator));
            server_world.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_w_delete", "adminmenu.server.world.create", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_w_delete_hover"), f.getRunCommand(), "/acb true atl_h_s_w adm_m_h_s_w true world delete %wo", translator));
            server_world.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_w_load", "adminmenu.server.world.load", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_w_load_hover"), f.getSuggestCommand(), "/world load <worldName>", translator));
            ...
            server_debug.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_d_start", "adminmenu.server.debug.start", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_d_start_hover"), f.getRunCommand(), "/debug start", translator));
            server_debug.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_d_stop", "adminmenu.server.debug.stop", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_d_stop_hover"), f.getRunCommand(), "/debug stop", translator));
            ...
            server_plugin.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_p_disable", "adminmenu.server.plugin.disable", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_p_disable_hover"), f.getRunCommand(), "/acb true atl_h_s_p adm_m_h_s_p true disableplugin %pl", translator));
            server_plugin.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_p_enable", "adminmenu.server.plugin.enable", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_p_enable_hover"), f.getRunCommand(), "/acb true atl_h_s_p adm_m_h_s_p true enableplugin %pl", translator));
            server_plugin.addEntry(EliteLib.getMenuFactory().newMenuEntry("itm_n_s_p_reload", "adminmenu.server.plugin.reload", f.colorYellow(), f.getShowText(), f.newChatComponent("itm_n_s_p_reload_hover"), f.getRunCommand(), "/acb true atl_h_s_p adm_m_h_s_p true reloadplugin %pl", translator));
