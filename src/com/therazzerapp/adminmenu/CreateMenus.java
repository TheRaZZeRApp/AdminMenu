    ...
    public static void initMenus (LocaleHelper translator){
        ...
        if (AdminMenu.settings.isPlayermenu()){
            ...
            EliteLib.getMenuManager().addMenu(addNavigation(player_02, translator, null,null, "adminmenu.menu.player_01", "/chatclick chatmenu adm_m_h_p_01"));
                ...
                player_ban.addEntry(EliteLib.getMenuFactory().newMenuEntry("i_p_ban_perm_reason", "adminmenu.player.ban.perm.reason",f.colorYellow(),f.getShowText(),f.newChatComponent("i_p_ban_reason_hover"),f.getSuggestCommand(),"/acb true atl_h_p_ban adm_m_h_p_ban true ban %p <reason>",translator));
                ...
                player_ban.addEntry(EliteLib.getMenuFactory().newMenuEntry("i_p_ban_temp_reason", "adminmenu.player.ban.temp.reason",f.colorYellow(),f.getShowText(),f.newChatComponent("i_p_ban_noreason_hover"),f.getSuggestCommand(),"/acb true atl_h_p_ban adm_m_h_p_ban true ban %p <reason> %t1",translator));
